...
import org.semanticwb.platform.SemanticObserver;
   ...
   */
public class VideoIn extends org.semanticwb.social.base.VideoInBase 
{
    public VideoIn(org.semanticwb.platform.SemanticObject base)
    {
        super(base);
    }
    ...
    static {
        ...
        VideoIn.social_VideoIn.registerObserver(new SemanticObserver() {
            public void notify(SemanticObject obj, Object prop, String lang, String action) {
                if(action!=null && obj.instanceOf(VideoIn.social_VideoIn))
                {
