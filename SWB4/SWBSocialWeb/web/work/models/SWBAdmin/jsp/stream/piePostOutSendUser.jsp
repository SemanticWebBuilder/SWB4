<%-- 
    Document   : piePostOutSendUser
    Created on : 2/04/2014, 11:20:20 AM
    ...
    JSONArray getObject(SemanticObject semObj, String lang, String idModel, String fi) throws Exception {
        ...
        if (filter.equals("all")) {
            while (it.hasNext()) {
                ...
                getJson(node, lista, totalPost, user.getName());
            ...
            while (it.hasNext()) {
                ...
                SemanticObject sem = SemanticObject.createSemanticObject(e.getKey().toString().trim());
                User user = (User) sem.createGenericInstance();
                if (filter.equals(user.getName())) {
                    ArrayList lista = (ArrayList) e.getValue();
                    getJson(node, lista, totalPost, user.getName(), filter);
                }
            }
        }
