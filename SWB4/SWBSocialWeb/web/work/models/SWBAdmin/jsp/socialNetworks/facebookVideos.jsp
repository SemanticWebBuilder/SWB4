...
<div class="swbform">
<div align="center"><h2>Showing <%=facebookBean.getTitle()%> Videos.</h2><br/></div>
<div class="bar" id="newVideosAvailable" dojoType="dojox.layout.ContentPane"></div>
<div id="videosStream" dojoType="dojox.layout.ContentPane"></div>
<%
    String objUri = (String) request.getParameter("suri");
    String since = (String)session.getAttribute("since");
    
    HashMap<String, String> params1 = new HashMap<String, String>(3);    
    params1.put("q", "SELECT actor_id, created_time, likes, post_id, attachment, message, comments FROM stream WHERE filter_key IN ( SELECT filter_key FROM stream_filter WHERE uid = me() AND name = 'Video') LIMIT 15");
