    ...
    try {
	    ...
	    //out.println("<div align=\"center\"><h2>" + "@" + twitterBean.getScreenName() + " - " + paramRequest.getLocaleString("favoritesLabel") +  "</h2><br/></div>");
            ...
            for (Status status : twitterBean.getFavorites(paging)){
                ...
                doPrintTweet(request, response, paramRequest, status, twitterBean, out, null, FAVORITES_TAB, postURI, user.hasUserGroup(userSuperAdminGrp), userCanRetopicMsg, userCanRespondMsg, userCanRemoveMsg);
                i++;
            }
