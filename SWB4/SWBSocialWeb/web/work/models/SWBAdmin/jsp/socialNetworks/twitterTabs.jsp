...
<%
        ...
        out.println("<div id=\""+ objUri + HOME_TAB +"\" dojoType=\"dijit.layout.ContentPane\" title=\""+"Home"+"\" refreshOnShow=\""+"false"+"\" href=\""+"/es/SWBAdmin/" + webPageId +"?" + param + "&contentTabId=homeTimeline" +"\" _loadingMessage=\""+loading+"\" style_=\"border:0px; width:100%; height:100%\">");
        out.println("</div>");
        
        out.println("<div id=\""+ objUri + MENTIONS_TAB +"\" dojoType=\"dijit.layout.ContentPane\" title=\""+"Mentions"+"\" refreshOnShow=\""+"false"+"\" href=\""+"/es/SWBAdmin/" + webPageId +"?" + param + "&contentTabId=mentions" +"\" _loadingMessage=\""+loading+"\" style_=\"border:0px; width:100%; height:100%\">");
        out.println("</div>");
        
        out.println("<div id=\""+ objUri + FAVORITES_TAB + "\" dojoType=\"dijit.layout.ContentPane\" title=\""+"Favorites"+"\" refreshOnShow=\""+"false"+"\" href=\""+"/es/SWBAdmin/" + webPageId + "?" + param + "&contentTabId=favorites" +"\" _loadingMessage=\""+loading+"\" style_=\"border:0px; width:100%; height:100%\">");
        out.println("</div>");
        
        out.println("<div id=\""+ objUri + DIRECT_MESSAGES_TAB +"\" dojoType=\"dijit.layout.ContentPane\" title=\""+"Direct Messages"+"\" refreshOnShow=\""+"false"+"\" href=\""+"/es/SWBAdmin/" + webPageId +"?" + param + "&contentTabId=directMessages" +"\" _loadingMessage=\""+loading+"\" style_=\"border:0px; width:100%; height:100%\">");
        out.println("</div>");

        out.println("<div id=\""+ objUri + USER_TWEETS_TAB +"\" dojoType=\"dijit.layout.ContentPane\" title=\""+"My Tweets"+"\" refreshOnShow=\""+"false"+"\" href=\""+"/es/SWBAdmin/" + webPageId +"?" + param + "&contentTabId=userTweets" +"\" _loadingMessage=\""+loading+"\" style_=\"border:0px; width:100%; height:100%\">");
        out.println("</div>");
        
        out.println("<div id=\""+ objUri + DISCOVER_TAB +"\" dojoType=\"dijit.layout.ContentPane\" title=\""+"Discover"+"\" refreshOnShow=\""+"true"+"\" href=\""+"/es/SWBAdmin/" + webPageId +"?" + param + "&contentTabId=discover" +"\" _loadingMessage=\""+loading+"\" style_=\"border:0px; width:100%; height:100%\">");
        out.println("</div>");        
