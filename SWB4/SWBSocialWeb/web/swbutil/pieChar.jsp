...
String args="?streamUri="+semObj.getURI();
 * */
WebSite wsite=WebSite.ClassMgr.getWebSite("Octavius");
Stream stream=Stream.ClassMgr.getStream("1", wsite); 
String args="?streamUri="+stream.getEncodedURI();
String lang="es";
args+="&lang="+lang;
%>
...
d3.json("streamSentimentData.jsp<%=args%>", function(error, data) {
  
d3.json(<%=getObject(stream, lang)%>, function(error, data) {  
