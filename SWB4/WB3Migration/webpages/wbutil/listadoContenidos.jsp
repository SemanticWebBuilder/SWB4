        ...
        <form name="fstep2" id="fstep2" method="post" action="" onsubmit="return valida(this);">
            ...
            <fieldset>
                ...
                <ul>
                    ...
                    %>
                    <li><input type="radio" id="<%=tm.getId()%>" name="site" value="<%=tm.getId()%>" <%= siteid!=null&&siteid.equals(tm.getId())?"checked":""%> ><label for="<%=tm.getId()%>"><%=tm.getDbdata().getTitle()%>&nbsp;<i><%=activo%></i></label></li>
                        <%
                                }
                            }
                        %>
