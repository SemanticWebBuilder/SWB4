...
%>        
        ...
        <script type="text/javascript">            
            ...
            function processData(txt)
            {
                ...
                $.post("/processCommand.jsp", { data:txt }, function(data) {
                        voice.value=data;
                });                   
            }
        </script>
        <script type="text/javascript">
            ...
            Dom.connect = (function(host) {
                ...
                } else 
                {
                    ...
                    {
                        $.post("/processCommand.jsp", { gmsg: "true" },
                        function(data) {
            ...
            Dom.initialize = function() {
                if (window.location.protocol == 'http:') {
                    Dom.connect('ws://' + window.location.host + '/websocket/dom');
                } else {
                    Dom.connect('wss://' + window.location.host + '/websocket/dom');
                }
