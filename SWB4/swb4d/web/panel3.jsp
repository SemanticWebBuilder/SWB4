<%-- 
    Document   : panel3
    Created on : 21-oct-2012, 18:34:38
...
<html manifest="music.manifest">
    ...
    <body>
        <div class="toolbar">
            ...
            <a class="button" href="#searchForm">Buscar</a>
        </div>

        <ul id="home" title="SWB4Domotic" selected="true">
            <li>
        ...
        <div id="themes" class="panel" title="Theme Switcher">
            ...
            <form id="theme-form" onsubmit="return false;" method="">
                <select onchange="return iui.ts.themeSelect(this)" name="themeSelect" size="1">
