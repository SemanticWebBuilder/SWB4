   ...
   */
    ...
    public static class ClassMgr
    {
       ...
       */
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.domotic.model.SendTwitterAction> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swb4d_domEvent, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.domotic.model.SendTwitterAction with a determined DomEvent
       ...
       */
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.domotic.model.SendTwitterAction> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swb4d_domEvent,value.getSemanticObject(),sclass));
            return it;
        }
    }
