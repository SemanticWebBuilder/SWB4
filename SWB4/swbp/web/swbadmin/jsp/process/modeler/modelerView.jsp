...
<body onload="Modeler.init('modeler');">
    <div id="toolBar" onmouseout="ToolBar.outToolBar();" onmouseover="ToolBar.overToolBar(); this.style.opacity=1;" style="position: fixed;">
        ...
        <div id="startEventsBar" class="subbarHidden" style="width: 385px;">
            ...
            <span class="messageStartEvent" title="Inicio por mensaje" onclick="Modeler.creationStart(this)"></span>
            <span class="timerStartEvent" title="Inicio temporizado"  onclick="Modeler.creationStart(this)"></span>
            <span class="ruleStartEvent" title="Inicio por regla de negocio" onclick="Modeler.creationStart(this)"></span>
            <span class="signalStartEvent" title="Inicio por señal" onclick="Modeler.creationStart(this)"></span>
            <span class="multiStartEvent" title="Inicio por eventos múltiples" onclick="Modeler.creationStart(this)"></span>
            <span class="parallelStartEvent" title="Inicio paralelo" onclick="Modeler.creationStart(this)"></span>
            <span class="scalaStartEvent" title="Inicio por escalamiento" onclick="Modeler.creationStart(this)"></span>
            <span class="errorStartEvent" title="Inicio por error" onclick="Modeler.creationStart(this)"></span>
            <span class="compensaStartEvent" title="Inicio por compensación"  onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="interEventsBar" class="subbarHidden" style="width: 645px;">
            <span class="subbarStart"></span>
            <span class="messageInterCatchEvent" title="Recepción de mensaje" onclick="Modeler.creationStart(this)"></span>
            <span class="messageInterThrowEvent" title="Disparo de mensaje" onclick="Modeler.creationStart(this)"></span>
            <span class="timerInterEvent" title="Temporizador" onclick="Modeler.creationStart(this)"></span>
            <span class="errorInterEvent" title="Error" onclick="Modeler.creationStart(this)"></span>
            <span class="cancelInterEvent" title="Cancelación" onclick="Modeler.creationStart(this)"></span>
            <span class="compensaInterCatchEvent" title="Recepción de compensación" onclick="Modeler.creationStart(this)"></span>
            <span class="compensaInterThrowEvent" title="Disparo de compensación" onclick="Modeler.creationStart(this)"></span>
            <span class="ruleInterEvent" title="Regla de negocio" onclick="Modeler.creationStart(this)"></span>
            <span class="linkInterCatchEvent" title="Continuación de enlace" onclick="Modeler.creationStart(this)"></span>
            <span class="linkInterThrowEvent" title="Inicio de enlace" onclick="Modeler.creationStart(this)"></span>
            <span class="signalInterCatchEvent" title="Recepción de señal" onclick="Modeler.creationStart(this)"></span>
            <span class="signalInterThrowEvent" title="Disparo de señal" onclick="Modeler.creationStart(this)"></span>
            <span class="multipleInterCatchEvent" title="Recepción múltiple" onclick="Modeler.creationStart(this)"></span>
            <span class="multipleInterThrowEvent" title="Disparo múltiple" onclick="Modeler.creationStart(this)"></span>
            <span class="scalaInterCatchEvent" title="Recepción de escalamiento" onclick="Modeler.creationStart(this)"></span>
            <span class="scalaInterThrowEvent" title="Disparo de escalamiento" onclick="Modeler.creationStart(this)"></span>
            <span class="parallelInterEvent" title="Paralelo" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="endEventsBar" class="subbarHidden" style="width: 348px;">
            <span class="subbarStart"></span>
            <span class="normalEndEvent" title="Fin normal" onclick="Modeler.creationStart(this)"></span>
            <span class="messageEndEvent" title="Fin con mensaje"  onclick="Modeler.creationStart(this)"></span>
            <span class="errorEndEvent" title="Fin con error"  onclick="Modeler.creationStart(this)"></span>
            <span class="cancelEndEvent" title="Fin con cancelación" onclick="Modeler.creationStart(this)"></span>
            <span class="compensaEndEvent" title="Fin con compensación"  onclick="Modeler.creationStart(this)"></span>
            <span class="signalEndEvent" title="Fin con señal" onclick="Modeler.creationStart(this)"></span>
            <span class="multiEndEvent" title="Fin múltiple"  onclick="Modeler.creationStart(this)"></span>
            <span class="escalaEndEvent" title="Fin con escalamiento" onclick="Modeler.creationStart(this)"></span>
            <span class="terminalEndEvent" title="Terminación" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="tasksBar" class="subbarHidden" style="width: 311px;">
            <span class="subbarStart"></span>
            <span class="abstractTask" title="Tarea abstracta" onclick="Modeler.creationStart(this)"></span>
            <span class="userTask" title="Tarea de usuario" onclick="Modeler.creationStart(this)"></span>
            <span class="serviceTask" title="Tarea de servicio" onclick="Modeler.creationStart(this)"></span>
            <span class="scriptTask" title="Tarea de script" onclick="Modeler.creationStart(this)"></span>
            <span class="ruleTask" title="Tarea de regla de negocio" onclick="Modeler.creationStart(this)"></span>
            <span class="manualTask" title="Tarea manual" onclick="Modeler.creationStart(this)"></span>
            <span class="sendTask" title="Tarea de envío de mensaje" onclick="Modeler.creationStart(this)"></span>
            <span class="receiveTask" title="Tarea de recepción de mensaje" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="subtasksBar" class="subbarHidden" style="width: 163px;">
            <span class="subbarStart"></span>
            <span class="subProcess" title="Subproceso" onclick="Modeler.creationStart(this)"></span>
            <span class="adhocsubProcess" title="Subproceso adhoc" onclick="Modeler.creationStart(this)"></span>
            <span class="eventsubProcess" title="Subproceso de evento" onclick="Modeler.creationStart(this)"></span>
            <span class="transactionsubProcess" title="Transacción" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="calltasksBar" class="subbarHidden" style="width: 237px;">
            <span class="subbarStart"></span>
            <span class="callTask" title="Tarea llamada" onclick="Modeler.creationStart(this)"></span>
            <span class="callmanualTask" title="Tarea manual llamada" onclick="Modeler.creationStart(this)"></span>
            <span class="callruleTask" title="Tarea de regla de negocio llamada" onclick="Modeler.creationStart(this)"></span>
            <span class="callscriptTask" title="Tarea de script llamada" onclick="Modeler.creationStart(this)"></span>
            <span class="calluserTask" title="Tarea de usuario llamada" onclick="Modeler.creationStart(this)"></span>
            <span class="callsubProcess" title="Subproceso llamado" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="gatewaysBar" class="subbarHidden" style="width: 274px;">
            <span class="subbarStart"></span>
            <span class="exclusiveDataGateway" title="Exclusiva (datos)" onclick="Modeler.creationStart(this)"></span>
            <span class="inclusiveDataGateway" title="Inclusiva (datos)" onclick="Modeler.creationStart(this)"></span>
            <span class="exclusiveStartEventGateway" title="Exclusiva de inicio" onclick="Modeler.creationStart(this)"></span>
            <span class="exclusiveEventGateway" title="Exclusiva (eventos)" onclick="Modeler.creationStart(this)"></span>
            <span class="parallelGateway" title="Paralela" onclick="Modeler.creationStart(this)"></span>
            <span class="parallelStartGateway" title="Paralela de inicio" onclick="Modeler.creationStart(this)"></span>
            <span class="complexGateway" title="Compleja" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="connectionsBar" class="subbarHidden" style="width: 237px;">
            <span class="subbarStart"></span>
            <span class="sequenceFlow" title="Flujo de secuencia" onclick="Modeler.creationStart(this)"></span>
            <span class="conditionalFlow" title="Flujo condicional" onclick="Modeler.creationStart(this)"></span>
            <span class="defaultFlow" title="Flujo por defecto" onclick="Modeler.creationStart(this)"></span>
            <span class="messageFlow" title="Flujo de mensaje" onclick="Modeler.creationStart(this)"></span>
            <span class="associationFlow" title="Asociación" onclick="Modeler.creationStart(this)"></span>
            <span class="directionalassociationFlow" title="Asociación direccional" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="artifactsBar" class="subbarHidden" style="width: 89px;">
            <span class="subbarStart"></span>
            <span class="annotation" title="Anotación" onclick="ToolKit.setLayer(null);
                    Modeler.creationStart(this)"></span>
            <span class="group" title="Grupo" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="dataobjectsBar" class="subbarHidden" style="width: 163px;">
            <span class="subbarStart"></span>
            <span class="dataObject" title="Dato" onclick="Modeler.creationStart(this)"></span>
            <span class="dataInput" title="Dato de entrada" onclick="Modeler.creationStart(this)"></span>
            <span class="dataOutput" title="Dato de salida" onclick="Modeler.creationStart(this)"></span>
            <span class="dataStore" title="Almacén de datos" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
        <div id="swimlanesBar" class="subbarHidden" style="width: 89px;">
            <span class="subbarStart"></span>
            <span class="pool" title="Pool" onclick="Modeler.creationStart(this)"></span>
            <span class="lane" title="Lane" onclick="Modeler.creationStart(this)"></span>
            <span class="subbarEnd"></span>
        </div>
    </div>
    ...
    <div style="margin-left:49px;">
        ...
        <!--rect id="resizeBox" x="-4.5" y="-4.5" width="9" height="9" class="resizeBox"/-->
