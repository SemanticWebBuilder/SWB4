    ...
    <div class="col-lg-2 col-md-2 col-sm-4 hidden-xs">
        <div class="swbp-left-menu swbp-left-menu-doc">
            <ul class="nav nav-pills nav-stacked">
                <%if (lane.size() > 0) {//Lane%>
                <li class="active"><a style="width: 100%;" href="#lanemenu" data-placement="bottom" data-toggle="tooltip" data-original-title="<%=laneT + " " + lane.size()%>" class=""><%=laneT%> <span class="badge pull-right"><%=lane.size()%></span></a></li>
                ...
                <li class="active"><a style="width: 100%;" href="#activitymenu" data-placement="bottom" data-toggle="tooltip" data-original-title="<%=activityT + " " + activity.size()%>"><%=activityT%> <span class="badge pull-right"><%=activity.size()%></span></a></li>
                ...
                <li class="active"><a style="width: 100%;" href="#gatewaymenu" data-placement="bottom" data-toggle="tooltip" data-original-title="<%=gatewayT + " " + gateway.size()%>"><%=gatewayT%> <span class="badge pull-right"><%=gateway.size()%></span></a></li>
                        <%while (iterator.hasNext()) {
                                ge = iterator.next();%>
                ...
                <li class="active"><a style="width: 100%;" href="#eventmenu" data-placement="bottom" data-toggle="tooltip" data-original-title="<%=eventT + " " + event.size()%>"><%=eventT%> <span class="badge pull-right"><%=event.size()%></span></a></li>
                ...
                <li class="active"><a style="width: 100%;" href="#dataobmenu" data-placement="bottom" data-toggle="tooltip" data-original-title="<%=dataOBT + " " + dataob.size()%>"><%=dataOBT%> <span class="badge pull-right"><%=dataob.size()%></span></a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title">
                        ...
                        <a href="<%=urlModel.setParameter("suri", suri)%>" target="_blank"
                            data-placement="bottom" data-toggle="tooltip" data-original-title="Ver modelo"
                           class="pull-right icon-fullscreen hidden-l"></a>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    <% if (pe instanceof org.semanticwb.process.model.SubProcess) {
            ...
            org.semanticwb.process.model.Process process1 = sp.getProcess();
    %>
        json = '<%=process1.getData()%>';
    <%}%>
