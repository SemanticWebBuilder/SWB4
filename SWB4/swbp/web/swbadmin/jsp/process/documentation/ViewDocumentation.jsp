    ...
    <div class="col-lg-2 col-md-2 col-sm-4 hidden-xs">
        <div class="swbp-left-menu swbp-left-menu-doc" <%if (despliege.equals("Vista")) {%>style="height: 91%;"<%}%>>
            <ul class="nav nav-pills nav-stacked">
                ...
                <!--li><a class="fa fa-arrow-right" data-placement="bottom" data-toggle="tooltip" data-original-title="<%//connectionObj.getTitle()%>" href="#<%//connectionObj.getURI()%>"><%//connectionObj.getTitle()%></a></li-->
                <%}
                             }*/
                        }
                    }
