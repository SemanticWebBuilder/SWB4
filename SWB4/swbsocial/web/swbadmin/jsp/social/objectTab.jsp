...
<%
    ...
    boolean var = site.getUserRepository().hasUser(user.getId());
...
<%
    ...
    //System.out.println("suri decoded:" + URLDecoder.decode((String)request.getAttribute("suri")));
    String id = (request.getAttribute("suri") == null ? (request.getParameter("suri") == null ? "" : request.getParameter("suri") ) : (String)request.getAttribute("suri"));
    ...
    out.println("<div dojoType=\"dijit.layout.ContentPane\" postCreate=\"setTabTitle('"+id+"','"+SWBUtils.TEXT.scape4Script(obj.getDisplayName(lang))+"','"+icon+"');\"  style=\"border:0px; width:100%; height:95%\"/>");

    out.println("<div dojoType=\"dijit.layout.TabContainer\" region=\"center\" style_=\"border:0px; width:100%; height:600px\" id=\""+id+"/tab2\" _tabPosition=\"bottom\" nested_=\"true\" _selectedChild=\"btab1\" onButtonClick_=\"alert('click');\" onLoad_=\"alert('Hola');\">");
