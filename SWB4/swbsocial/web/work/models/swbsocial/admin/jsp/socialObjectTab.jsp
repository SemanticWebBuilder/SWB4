...
<%
    System.out.println("Entra a Jsp SocialTab");
%>
<%!
...
<%
    ...
    System.out.println("Entra a Jsp SocialTab-J1,user:"+user);
    if(user==null)
    {
        response.sendError(403);
        return;
    }
    System.out.println("Entra a Jsp SocialTab-2");
%>
<%
    System.out.println("Entra a Jsp SocialTab-3");
    String lang="es";
