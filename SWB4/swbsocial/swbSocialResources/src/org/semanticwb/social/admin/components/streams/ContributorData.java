...
public class ContributorData {
    ...
    private static List<LanguageContribution> languageContributions = new ArrayList<LanguageContribution>();
    ...
    {
        public void run() {
            System.out.println("Entra a updateDataJorge");
           languageContributions.add(new LanguageContribution("Espanglis", "Jorge-1", "iso-8859-5"));
           languageContributions.add(new LanguageContribution("K te importa 1", "Jorge-2", "iso-8859-9"));
           languageContributions.add(new LanguageContribution("K te importa 2", "Jorge-3", "iso-8859-1"));
           languageContributions.add(new LanguageContribution("K te importa 3 ", "Jorge-4", "iso-8859-2"));
        }
     }
