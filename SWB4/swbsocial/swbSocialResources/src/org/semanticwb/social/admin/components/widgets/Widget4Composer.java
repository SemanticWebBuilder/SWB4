 ...
 */
public class Widget4Composer extends GenericForwardComposer {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        try
        {
            ...
            if(paramRequest!=null)
            {
                ...
                if(wsiteAdm!=null)
                {
                    WebPage wpWidget=wsiteAdm.getWebPage("Widget_4");
                    if(wpWidget!=null)
                    {
                        user=paramRequest.getUser();
                        widgetIframe4.setSrc(wpWidget.getUrl(user.getLanguage()));
                    }
                }
            }
        }catch(Exception e)
