 ...
 */
public class Widget3Composer extends GenericForwardComposer {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        try
        {
            ...
            if(paramRequest!=null)
            {
                ...
                if(wsiteAdm!=null)
                {
                    WebPage wpWidget=wsiteAdm.getWebPage("Widget_3");
                    if(wpWidget!=null)
                    {
                        user=paramRequest.getUser();
                        widgetIframe3.setSrc(wpWidget.getUrl(user.getLanguage()));
                    }
                }
            }
        }catch(Exception e)
