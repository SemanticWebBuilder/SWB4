 ...
 */
public class Widget1Composer extends GenericForwardComposer {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        try
        {
            ...
            if(paramRequest!=null)
            {
                ...
                if(wsiteAdm!=null)
                {
                    WebPage wpWidget=wsiteAdm.getWebPage("Widget_1");
                    if(wpWidget!=null)
                    {
                        user=paramRequest.getUser();
                        widgetIframe1.setSrc(wpWidget.getUrl(user.getLanguage()));
                    }
                }
            }
        }catch(Exception e)
