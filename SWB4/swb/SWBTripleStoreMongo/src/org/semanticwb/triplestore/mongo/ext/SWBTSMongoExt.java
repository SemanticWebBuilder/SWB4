 ...
 * @author jei
 */
public class SWBTSMongoExt implements AbstractStore
{
    private static Logger log=SWBUtils.getLogger(SWBTSMongoExt.class);

    SWBTSMongoModelMakerExt maker;
    ...
    public void init()
    {
        log.event("SWBTSMongoExt Initializing...");
        maker=new SWBTSMongoModelMakerExt();
    }
    ...
    public SWBTSMongoModelMakerExt getMaker()
    {
        return maker;
    }
}
