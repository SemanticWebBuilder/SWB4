...
public abstract class AnswerBase extends org.semanticwb.model.SWBClass 
{
    ...
    public static class ClassMgr
    {
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.resources.sem.forumcat.Answer> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(forumCat_ansQuestion, ansquestion.getSemanticObject(),sclass));
            return it;
        }
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.resources.sem.forumcat.Answer> it=new org.semanticwb.model.GenericIterator(ansquestion.getSemanticObject().getModel().listSubjectsByClass(forumCat_ansQuestion,ansquestion.getSemanticObject(),sclass));
            return it;
        }
    }
