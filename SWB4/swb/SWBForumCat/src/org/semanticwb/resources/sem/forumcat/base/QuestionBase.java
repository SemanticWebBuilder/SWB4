...
public abstract class QuestionBase extends org.semanticwb.model.SWBClass 
{
    ...
    public static class ClassMgr
    {
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.resources.sem.forumcat.Question> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(forumCat_queforum, queforum.getSemanticObject(),sclass));
            return it;
        }
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.resources.sem.forumcat.Question> it=new org.semanticwb.model.GenericIterator(queforum.getSemanticObject().getModel().listSubjectsByClass(forumCat_queforum,queforum.getSemanticObject(),sclass));
            return it;
        }
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.resources.sem.forumcat.Question> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(forumCat_webpage, webpage.getSemanticObject(),sclass));
            return it;
        }
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.resources.sem.forumcat.Question> it=new org.semanticwb.model.GenericIterator(webpage.getSemanticObject().getModel().listSubjectsByClass(forumCat_webpage,webpage.getSemanticObject(),sclass));
            return it;
        }
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.resources.sem.forumcat.Question> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(forumCat_hasAnswerInv, hasanswerinv.getSemanticObject(),sclass));
            return it;
        }
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.resources.sem.forumcat.Question> it=new org.semanticwb.model.GenericIterator(hasanswerinv.getSemanticObject().getModel().listSubjectsByClass(forumCat_hasAnswerInv,hasanswerinv.getSemanticObject(),sclass));
            return it;
        }
    }
    ...
    public boolean hasAnswerInv(org.semanticwb.resources.sem.forumcat.Answer answer)
    {
        ...
        if(answer!=null)
        {
           ret=getSemanticObject().hasObjectProperty(forumCat_hasAnswerInv,answer.getSemanticObject());
        }
        return ret;
    }
