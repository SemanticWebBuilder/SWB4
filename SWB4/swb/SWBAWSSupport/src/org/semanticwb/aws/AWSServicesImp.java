...
public final class AWSServicesImp implements SWBCloud {
    ...
    private String getFormConfig(SWBParamRequest paramRequest, final List<String> secGrp, final boolean launched) {
        ...
        if (!launched) {
            forma = "<form id=\"configAWS\" dojoType=\"dijit.form.Form\" class=\"swbform\" action=\""
                    ...
                    + "                <tr><td width=\"200px\" align=\"right\"><label for=\"InstanceType\">InstanceType &nbsp;</label></td><td><select name=\"InstanceType\" >" + getInstanceTypesStr() + "</td></tr>\n"
                    ...
                    + "                <tr><td width=\"200px\" align=\"right\"><label for=\"LoadBal\">LoadBalancer &nbsp;</label></td><td><select name=\"LoadBal\" >" + getLoadBalancersStr() + "</td></tr>\n"
    ...
    private String getImagesID() {
        ...
        for (String name : getImagesNames()) {
            int i = name.indexOf("|");
            if (name.substring(0, i).equalsIgnoreCase(value)) {
                checked = " selected=\"true\"";
            } else {
                checked = "";
            }
    ...
    private String getFormShutdown(final SWBParamRequest paramRequest) {
        log.trace("AWSServicesImp.getFormShutdown");
        String list = "";
        ...
        log.trace("AWSServicesImp.getFormShutdown list:"+list);
