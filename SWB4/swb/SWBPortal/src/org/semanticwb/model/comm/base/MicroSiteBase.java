...
public class MicroSiteBase extends org.semanticwb.model.WebPage implements org.semanticwb.model.Viewable,org.semanticwb.model.Descriptiveable,org.semanticwb.model.Activeable,org.semanticwb.model.TemplateRefable,org.semanticwb.model.Trashable,org.semanticwb.model.Rankable,org.semanticwb.model.Indexable,org.semanticwb.model.RoleRefable,org.semanticwb.model.PFlowRefable,org.semanticwb.model.Calendarable,org.semanticwb.model.Referensable,org.semanticwb.model.Resourceable,org.semanticwb.model.Undeleteable,org.semanticwb.model.Hiddenable,org.semanticwb.model.RuleRefable,org.semanticwb.model.Filterable,org.semanticwb.model.Traceable,org.semanticwb.model.UserGroupRefable
{
    ...
    public static final org.semanticwb.platform.SemanticProperty swbcomm_isAbout=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticProperty("http://www.semanticwebbuilder.org/swb4/community#isAbout");
    ...
    public static final org.semanticwb.platform.SemanticProperty swbcomm_isLocatedIn=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticProperty("http://www.semanticwebbuilder.org/swb4/community#isLocatedIn");
    ...
    public void setIsAbout(org.semanticwb.model.WebPage webpage)
    {
        getSemanticObject().setObjectProperty(swbcomm_isAbout, webpage.getSemanticObject());
    }

    public void removeIsAbout()
    {
        getSemanticObject().removeProperty(swbcomm_isAbout);
    }

    public org.semanticwb.model.WebPage getIsAbout()
    {
         org.semanticwb.model.WebPage ret=null;
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(swbcomm_isAbout);
         if(obj!=null)
         {
    ...
    public void setIsLocatedIn(org.semanticwb.model.catalogs.LocationEntity locationentity)
    {
        getSemanticObject().setObjectProperty(swbcomm_isLocatedIn, locationentity.getSemanticObject());
    }

    public void removeIsLocatedIn()
    {
        getSemanticObject().removeProperty(swbcomm_isLocatedIn);
    }

    public org.semanticwb.model.catalogs.LocationEntity getIsLocatedIn()
    {
         org.semanticwb.model.catalogs.LocationEntity ret=null;
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(swbcomm_isLocatedIn);
         if(obj!=null)
         {
