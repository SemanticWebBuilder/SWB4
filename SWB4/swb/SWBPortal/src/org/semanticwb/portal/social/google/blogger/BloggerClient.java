...
//        "<p>SemanticWebBuilder Open Source:(<p>",
...
//    printDateRangeQueryResults(myService, DateTime.parseDate("2009-09-04"),
//        DateTime.parseDate("2009-09-06"));
//
...
//        + draftPost.getTitle().getPlainText() + "\".\n");
//    publicPost = updatePostTitle(myService, publicPost, ">INFOTEC SemanticWebBuilder Open Source Jei");
//    System.out.println("Post's new title is \""
//        + publicPost.getTitle().getPlainText() + "\".\n");
//
...
//    Entry comment = createComment(myService, postId, "Prueba de comentario Jorge");
//
