...
public class SWBBannerBase extends org.semanticwb.portal.api.GenericSemResource 
{
    ...
    public static final org.semanticwb.platform.SemanticProperty swbres_image=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticProperty("http://www.semanticwebbuilder.org/portal/resources#image");
