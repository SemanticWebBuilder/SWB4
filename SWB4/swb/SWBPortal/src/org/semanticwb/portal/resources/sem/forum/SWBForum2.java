...
public class SWBForum2 extends org.semanticwb.portal.resources.sem.forum.base.SWBForumBase
{
    ...
    public SWBForum2(org.semanticwb.platform.SemanticObject base)
    {
        super(base);
    }

    private static Logger log = SWBUtils.getLogger(SWBForum2.class);
        ...
        if (action.equals("addThread")) {
            if(request.getParameter("title")!=null){
                try
                {
                    ...
                    //newThread.setForum(this);  --> ESTA LINEA LA TENGO QUE DESCOMENTAR Y HACER QUE FUNCIONE ESTA NUEVA VERSION DEL FORO, COMENTADO EL 22/DIC/2009
