 ...
 */
public class PowerPointContent extends GenericAdmResource
{

    private static Logger log = SWBUtils.getLogger(PowerPointContent.class);
    ...
    {
        if (base instanceof PPTPortlet)
        {
            String basePath = SWBUtils.getApplicationPath() + base.getWorkPath() + "/";
            clean(base);
            PPTPortlet portlet = (PPTPortlet) base;
