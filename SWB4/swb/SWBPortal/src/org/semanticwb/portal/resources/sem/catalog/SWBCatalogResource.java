...
//                        urlback.setParameter("suri", id);
    ...
    public void doForm(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        if(sval!=null) obj=ont.getSemanticObject(sval);
        else obj = getCatalogClass();
        ...
        /*
            ...
            //if (getCatalogClass()!=null) 
            {
                ...
                if (getCatalogClass() == null) {
                    ...
                    out.println("<div class=\"swbform\">");
                    out.println("<fieldset>");
                    out.println("<legend>" + paramsRequest.getLocaleString("erroMsgConfig") + " \"" + base.getDisplayTitle(user.getLanguage()) + "\" </legend>");
                    out.println("<ul style=\"list-style:none;\">");
                    out.println("<li>");
...
//                        urlback.setParameter("suri", id);
    ...
    public void processAction(HttpServletRequest request, SWBActionResponse response) throws SWBResourceException, IOException {
        ...
        } else if ("removeso".equals(action))
        {
            ...
            if(proptype.equals("search")) its = listSearchPropertieses();
            if(proptype.equals("display")) its = listListPropertieses();
            String semprop = null;
