...
public class ModererationCatBase extends org.semanticwb.model.SWBClass implements org.semanticwb.model.Descriptiveable
{
    ...
    public static final org.semanticwb.platform.SemanticClass sclass=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticClass("http://www.semanticwebbuilder.org/swb4/forum#ModererationCat");

    public ModererationCatBase(org.semanticwb.platform.SemanticObject base)
    {
        super(base);
    }
    ...
    {
        return (org.semanticwb.portal.resources.sem.forum.ModererationCat)model.getSemanticObject().getModel().createGenericObject(model.getSemanticObject().getModel().getObjectUri(id, sclass), sclass);
    }

    public static void removeModererationCat(String id, org.semanticwb.model.SWBModel model)
    {
        model.getSemanticObject().getModel().removeSemanticObject(model.getSemanticObject().getModel().getObjectUri(id,sclass));
    }

    public static boolean hasModererationCat(String id, org.semanticwb.model.SWBModel model)
    {
        return (getModererationCat(id, model)!=null);
    }
