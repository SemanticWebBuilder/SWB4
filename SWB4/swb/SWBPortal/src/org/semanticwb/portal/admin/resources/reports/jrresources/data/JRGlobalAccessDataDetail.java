...
import org.semanticwb.portal.admin.resources.reports.datadetail.GlobalAccessDataDetail;
...
/**
 * The Class JRGlobalAccessDataDetail.
 */
public class JRGlobalAccessDataDetail implements JRDataSourceable{
    
    /** The data detail. */
    private SWBDataDetail dataDetail;
    
    /**
     * Instantiates a new jR global access data detail.
     * 
     * @param filterReportBean the filter report bean
     */
    public JRGlobalAccessDataDetail(WBAFilterReportBean filterReportBean){
        dataDetail = new GlobalAccessDataDetail(filterReportBean);
    }
