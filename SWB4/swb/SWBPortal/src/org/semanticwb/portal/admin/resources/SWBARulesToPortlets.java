 ...
 */
public class SWBARulesToPortlets extends GenericResource {

    private Logger log = SWBUtils.getLogger(SWBARulesToPortlets.class);
    private HashMap hhashmap = new HashMap();
    
    /** Creates a new instance of WBARoles2Resources */
    public SWBARulesToPortlets() {
    }
