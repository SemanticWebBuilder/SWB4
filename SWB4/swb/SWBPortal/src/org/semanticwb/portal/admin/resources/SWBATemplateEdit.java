                ...
                if (action == null || action.equals("")) {
                    ...
                    if (null != vio) {
                        while (vio != null) {
                            ...
                            out.println("<a href=\"#\" onclick=\"submitUrl('" + urle + "',this); return false;\">edit template</a>");

                            SWBResourceURL urlec = paramRequest.getRenderUrl();
                            urlec.setParameter("suri", id);
                            urlec.setParameter("sobj", vio.getURI());
                            urlec.setParameter("act", "edit");
                            urlec.setMode(SWBResourceURL.Mode_EDIT);
                            out.println("<a href=\"#\" onclick=\"submitUrl('" + urlec + "',this); return false;\">edit comment</a>");
...
//                    out.println("</tfoot>");
    ...
    public void doEdit(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        if (action.equals("newversion")) {
            ...
            String vnum = request.getParameter("vnum")!=null?request.getParameter("vnum"):"1";
