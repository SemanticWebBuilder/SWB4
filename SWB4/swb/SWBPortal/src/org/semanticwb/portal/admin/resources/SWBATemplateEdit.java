    ...
    public void processAction(HttpServletRequest request, SWBActionResponse response) throws SWBResourceException, IOException {
        ...
        if ("newversion".equals(act)) {
            if (go instanceof Versionable) {
                ...
                if(request.getParameter("vnum")==null) nvinf.setProperty(VersionInfo.ClassMgr.swb_versionFile, "template.html");
...
//                    System.out.println("Archivo:"+vi.getVersionFile());
                    ...
                    nvinf.setProperty(VersionInfo.ClassMgr.swb_versionFile, vi.getVersionFile());
