 ...
 */
public class SWBAPortlets extends GenericResource  {

     private Logger log=SWBUtils.getLogger(SWBAPortlets.class);
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        if(request.getParameter("WBAGotoTree")!=null) {
            ...
            if(!res.getWebSiteId().equals(request.getParameter("tm"))) {
                ...
                tmtype=res.getPortletType().getId()+".";
            }
            String tmstype="";
            //if(!res.getResourceBase().getSubTypeMap().equals(request.getParameter("tm"))) {
            if(!res.getPortletSubType().getWebSite().getId().equals(request.getParameter("tm"))) {
                if(res.getPortletSubType().getId()!=null){ //1if(res.getResourceBase().getSubType()>0) {
                    tmstype="0"+res.getPortletSubType().getId()+".";
                }
            }else {
                //if(res.getResourceBase().getSubType()>0) {
                if(res.getPortletSubType().getId()!=null) {
                
                    tmstype=res.getPortletSubType().getId()+".";
                }
            }
            out.print("<script>");
...
//                resSrv=new ResourceSrv();
                ...
                //Portlet recRes1=resSrv.copyResource(recRes.getWebSiteId(), recRes.getId(),paramRequest.getLocaleString("msgCopyResource")+" "+recRes.getTitle(),user.getId());
                Portlet recRes1=recRes;
    ...
    public void doEdit(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        if(act!=null&&act.equals("add")){
            ...
            if(request.getParameter("reload")!=null && request.getParameter("reload").equals("1")){
                ...
                String restype=SWBContext.getWebSite(request.getParameter("typemap")).getPortletType(request.getParameter("type")).getId();
                if(restype.equals("2")){ // de tipo adversiting
                    String tmtype="";
            ...
            out.println("<tr><td align=\"right\" class=\"datos\">"+paramRequest.getLocaleString("msgType")+"</td><td class=\"valores\" align=\"left\">"+recRes.getPortletType().getTitle()+"</td></tr>");
            ...
            //Iterator<PortletSubType> itSubtypes=DBCatalogs.getInstance().getSubTypes(TopicMgr.TM_GLOBAL,recRes.getType(),recRes.getTypeMap());
            Iterator<PortletSubType> itSubtypes=SWBContext.getGlobalWebSite().getPortletType(recRes.getPortletType().getId()).listSubTypes();
            while(itSubtypes.hasNext()){
                PortletSubType recSType=itSubtypes.next();
                if(recSType.getId().equals(recRes.getPortletSubType().getId()) && recSType.getWebSite().getId().equals(recRes.getPortletSubType().getWebSite().getId())) {
            ...
            itSubtypes=SWBContext.getWebSite(request.getParameter("tm")).getPortletType(recRes.getPortletType().getId()).listSubTypes();
            while(itSubtypes.hasNext()){
                PortletSubType recSType=itSubtypes.next();
                if(recSType.getId().equals(recRes.getPortletSubType().getId()) && recSType.getWebSite().getId().equals(recRes.getPortletSubType().getId())) {
            ...
            if(recRes.getPortletSubType().getId().equals("0")) out.println("<option value=\"0\" Selected>"+paramRequest.getLocaleString("msgSubtypeDefault")+"</option>");
            ...
            */
            ...
            url.setResourceBase(SWBContext.getWebSite(recRes.getWebSiteId()).getPortlet(recRes.getId()));
            url.setParameter("tpcomm","WBAd_mnui_ResourceAdmin");
            ...
            out.println("<tr><td align=\"right\" class=\"datos\">"+paramRequest.getLocaleString("msgType")+"</td><td class=\"valores\" align=\"left\">"+recRes.getPortletType().getTitle()+"</td></tr>");
            out.println("<tr><td align=\"right\" class=\"datos\">"+paramRequest.getLocaleString("msgSubtype")+"</td><td class=\"valores\" align=\"left\">");
            if(recRes.getPortletSubType().getId().equals("0")) out.println(""+paramRequest.getLocaleString("msgSubtypeDefault"));
            else out.println(recRes.getPortletSubType().getTitle());
            out.println("</td></tr>");
            Portlet resource=recRes;
            //TODO: dateFormat
            out.println("<tr><td align=\"right\" class=\"datos\">"+paramRequest.getLocaleString("msgCreationDate")+"</td><td class=\"valores\" align=\"left\">"+recRes.getCreated().toString()+"</td></tr>");
            out.println("<tr><td align=\"right\" class=\"datos\">"+paramRequest.getLocaleString("msgLastUpdate")+"</td><td class=\"valores\" align=\"left\">"+recRes.getUpdated().toString()+"</td></tr>");
            out.println("<tr><td align=\"right\" class=\"datos\">"+paramRequest.getLocaleString("msgResourceAppearances")+"</td><td class=\"valores\" align=\"left\">"+recRes.getViews()+"</td></tr>");
    ...
    public void processAction(HttpServletRequest request, SWBActionResponse response) throws SWBResourceException, java.io.IOException {
        ...
        try{
            ...
            if(accion.equals("status")){
                ...
                Portlet Recres=ws.getPortlet(request.getParameter("id"));
                ...
                res.setPortletSubType(SWBContext.getWebSite(stypemap).getPortletSubType(stype));
                ...
                response.setRenderParameter("stypemap",res.getPortletSubType().getWebSite().getId());
    ...
    public void doProcessRedirec(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        if(act!=null && (act.equals("add") || act.equals("copyRes"))){
            ...
            if(act.equals("add")){
                ...
                //SWBContext.getWebSite(recRes.getWebSiteId()).getPortlet(recRes.getId()).getResourceBase();
                Portlet res=recRes;
                ...
                recRes = SWBContext.getWebSite(request.getParameter("tm")).getPortlet((String)request.getAttribute("id"));
                typemap=recRes.getPortletType().getWebSite().getId();
                type=recRes.getPortletType().getId();
                stype=recRes.getPortletSubType().getId();
                stypemap=recRes.getPortletSubType().getWebSite().getId();
            }
            String restype=SWBContext.getWebSite(typemap).getPortletType(type).getId();
            if(restype.equals("2")){ // de tipo adversiting
                String tmtype="";
