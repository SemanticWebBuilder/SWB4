 ...
 */
public class SWBAAssignedRoles extends GenericResource {

    /** Creates a new instance of WBAAssignedRoles */
    public SWBAAssignedRoles()
    {
    }

    
    /**
     * User view of WBAAssignedRoles resource
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        if(request.getParameter("id")!=null)
        {
            ...
            Role hmtps = SWBContext.getWebSite(tmid).getUserRepository().getRole(id);
            ...
            while(itt.hasNext())
            {
                ...
                if(obj instanceof WebPage)
                {
                    ...
                    boolean tp_active = tp.getRoleRef().isActive();
