...
import org.semanticwb.portal.admin.resources.reports.datadetail.LoggedUserDataDetail;
...
/**
 * The Class JRLoggedUserDataDetail.
 */
public class JRLoggedUserDataDetail implements JRDataSourceable{
    ...
    /**
     * Instantiates a new jR logged user data detail.
     * 
     * @param filterReportBean the filter report bean
     */
    public JRLoggedUserDataDetail(WBAFilterReportBean filterReportBean){
