 ...
 */
public class SWBAPortletInfo extends GenericResource {

    /** Creates a new instance of SWBAPortletInfo */
    public SWBAPortletInfo() {
    }
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        if(id!=null && typeMap!=null){
            PortletType rResType = SWBContext.getWebSite(typeMap).getPortletType(id);
            ...
            out.println("</td>");
            out.println("<td class=\"valores\">");
            out.println(rResType.getPortletBundle());
            out.println("</td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td class=\"datos\" align=\"right\" width=150>");
            ...
            if(rResType.getPortletCache()>0) strChecked = "checked";
            out.println("<input type=checkbox name=cached disabled "+strChecked+"> "+rResType.getPortletCache());
            out.println("</td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td class=\"datos\" align=\"right\" width=150>");
            ...
            out.println("</td>");
            out.println("<td class=\"valores\">");
            out.println(rResType.getPortletClassName());
            out.println("</td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td class=\"datos\" align=\"right\" width=150>");
            ...
            out.println("<td class=\"valores\">");
            String strType = "";
            if(rResType.getPortletMode()==1) strType=paramRequest.getLocaleString("msgTypeContent");
            if(rResType.getPortletMode()==2) strType=paramRequest.getLocaleString("msgTypeStrategy");
            if(rResType.getPortletMode()==3) strType=paramRequest.getLocaleString("msgTypeSystem");
            if(rResType.getPortletMode()==4) strType=paramRequest.getLocaleString("msgTypeInner");
            out.println(strType);
            out.println("</td>");
            out.println("</tr>");
            out.println("</table>");
