...
public class CatalogsBase extends org.semanticwb.model.SWBModel 
{
    ...
    public static java.util.Iterator<org.semanticwb.catalogs.Catalogs> listCatalogss(org.semanticwb.model.SWBModel model)
    {
        java.util.Iterator it=model.getSemanticObject().getModel().listInstancesOfClass(sclass);
        return new org.semanticwb.model.GenericIterator<org.semanticwb.catalogs.Catalogs>(it, true);
    }

    public static java.util.Iterator<org.semanticwb.catalogs.Catalogs> listCatalogss()
    {
