...
public class TemplateBase extends SemanticObject implements RoleRefable,Calendarable,Versionable,Statusable,Deleteable,WebSiteable,Groupable,RuleRefable,Descriptiveable,Localeable,Referensable
{
    public TemplateBase(com.hp.hpl.jena.rdf.model.Resource res)
    {
        super(res);
    }
