...
public class StrategyBase extends SemanticObject implements Priorityable,RoleRefable,Groupable,Deleteable,WebSiteable,Referensable,Localeable,RuleRefable,Calendarable,Descriptiveable,Statusable
{
    public StrategyBase(com.hp.hpl.jena.rdf.model.Resource res)
    {
        super(res);
    }
