...
public class HomePageBase extends SemanticObject implements RoleRefable,Deleteable,WebSiteable,Referensable,RuleRefable,Descriptiveable,Calendarable,TemplateRefable,ResourceRefable,Statusable
{
    public HomePageBase(com.hp.hpl.jena.rdf.model.Resource res)
    {
        super(res);
    }
