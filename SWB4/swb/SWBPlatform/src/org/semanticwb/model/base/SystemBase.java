...
public class SystemBase extends SemanticObject implements Priorityable,RoleRefable,Groupable,Deleteable,WebSiteable,Referensable,Localeable,RuleRefable,Calendarable,Descriptiveable,Statusable
{
    public SystemBase(com.hp.hpl.jena.rdf.model.Resource res)
    {
        super(res);
    }
