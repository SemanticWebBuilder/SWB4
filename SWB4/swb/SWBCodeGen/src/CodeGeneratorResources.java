...
public class CodeGeneratorResources
{
    ...
    public void codeGen(String []args)
    {
        ...
        SWBPlatform.getSemanticMgr().addBaseOntology(base+"../../../SWBPortal/src/org/semanticwb/portal/resources/sem/forum/SWBForum.owl");
        System.out.println(new File(base+"../../../SWBPortal/src/org/semanticwb/portal/resources/sem/forum/SWBForum.owl").exists());
        ...
        try
        {
            ...
            codeGeneration.generateCode("frm",false,dir);
