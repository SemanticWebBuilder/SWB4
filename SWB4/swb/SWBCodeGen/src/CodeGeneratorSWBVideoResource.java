 ...
 * @author serch
 */
public class CodeGeneratorSWBVideoResource
{
    public static void main(String []args)
    {
        new CodeGeneratorSWBVideoResource().codeGen(args);
    }
    ...
    public void codeGen(String []args)
    {
        ...
        //SWBPlatform.getSemanticMgr().addBaseOntology(base+"../../../web/WEB-INF/owl/SWBVideo.owl");
        ...
        try
        {
            ...
            codeGeneration.generateCode("swbv",true,dir);
