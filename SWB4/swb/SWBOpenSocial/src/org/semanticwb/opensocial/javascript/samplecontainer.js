...
(function(){
  ...
  */
  ...
  var gadgetUrl = (gadgetUrlMatches)
      ? gadgetUrlMatches[1]
      : baseUrl + '/swb/samplecontainer/examples/SocialHelloWorld.xml';
  ...
  function generateGadgets(metadata) {
    ...
    for (var i = 0; i < metadata.gadgets.length; i++) {
      ...
      //alert('iframeBaseUrl: '+iframeBaseUrl);
      //alert('baseUrl: '+baseUrl);
      //var iframeBaseUrl = baseUrl.replace("localhost", "127.0.0.1") + '../../swb/gadgets/ifr/';
      var iframeBaseUrl = '<%=ifr%>';
