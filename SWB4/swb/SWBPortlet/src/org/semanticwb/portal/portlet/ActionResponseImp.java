...
public class ActionResponseImp extends PortletResponseImp implements ActionResponse
{
    ...
    public ActionResponseImp(HttpServletResponse servletResponse, SWBActionResponse actionResponse)
    {
  ...
  {
      actionResponse.setWindowState(windowState.toString());
  }
  ...
  {
      actionResponse.setMode(portletMode.toString());
  }
  ...
  {
      actionResponse.setRenderParameter(key,values);
  }
