...
public class RuleApplet extends javax.swing.JApplet implements CommandListener
{
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        jButton1.setText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Save"));
        jButton1.setToolTipText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Save"));
        ...
        jToggleButton1.setToolTipText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Pointer"));
        Elements.add(jToggleButton1);
        jToggleButton1.setActionCommand("POINT");
        jToggleButton1.setLabel(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Point"));
        ...
        jToggleButton2.setText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Cond"));
        jToggleButton2.setToolTipText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Condition"));
        ...
        jToggleButton3.setText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("And"));
        jToggleButton3.setToolTipText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("And"));
        ...
        jToggleButton4.setText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Or"));
        jToggleButton4.setToolTipText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Or"));
        ...
        jToggleButton5.setText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Not"));
        jToggleButton5.setToolTipText(java.util.ResourceBundle.getBundle("applets/rules/RuleApplet",locale).getString("Negation"));
