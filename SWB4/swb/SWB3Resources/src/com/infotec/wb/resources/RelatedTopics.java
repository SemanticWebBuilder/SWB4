...
public class RelatedTopics extends GenericAdmResource 
{
    ...
    String path = SWBPlatform.getContextPath() +"/swbadmin/xsl/RelatedTopics/";
    ...
    public void setResourceBase(Resource base)
    {
        ...
        if(tpl==null)
        {
            try { tpl = SWBUtils.XML.loadTemplateXSLT(SWBPortal.getAdminFileStream("/swbadmin/xsl/RelatedTopics/RelatedTopics.xslt")); }
