...
public class SimpleLexer extends Lexer {
    ...
    public final void mVAR() throws RecognitionException {
        try {
            int _type = VAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/hasdai/Documentos/sLexer.g:21:5: ( ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '√°' | '√©' | '√≠' | '√≥' | '√∫' | '\\u00C1' | '√â' | '√ç' | '√ì' | '√ö' | '√ë' | '√±' )+ )
            // /home/hasdai/Documentos/sLexer.g:21:7: ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '√°' | '√©' | '√≠' | '√≥' | '√∫' | '\\u00C1' | '√â' | '√ç' | '√ì' | '√ö' | '√ë' | '√±' )+
            {
            // /home/hasdai/Documentos/sLexer.g:21:7: ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '√°' | '√©' | '√≠' | '√≥' | '√∫' | '\\u00C1' | '√â' | '√ç' | '√ì' | '√ö' | '√ë' | '√±' )+
            int cnt15=0;
            loop15:
