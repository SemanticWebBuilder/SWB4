...
public class PingTest 
{
    ...
    public static void main(String args[])
    {
        ...
        try{
            //ping.testSocketWriteReadLatency();
            ping.testSocketWriteReadThroughput();
            ping.testSocketLatency();
            ping.testSocketThreadedThroughput();
    ...
    public void testSocketWriteReadLatency() throws IOException, InterruptedException {
        ...
        for (int i = -times.length; i < times.length; i++) {
