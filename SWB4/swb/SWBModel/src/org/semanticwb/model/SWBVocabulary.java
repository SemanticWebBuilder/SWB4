...
public class SWBVocabulary
{
    ...
    public final SemanticClass DisplayProperty;
    ...
    public final SemanticClass FormViewRef;
    ...
    public SWBVocabulary()
    {
        ...
        DisplayProperty=vocabulary.getSemanticClass(URI+"DisplayProperty");
        ...
        FormViewRef=vocabulary.getSemanticClass(URI+"FormViewRef");
