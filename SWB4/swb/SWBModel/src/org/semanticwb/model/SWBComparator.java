...
public class SWBComparator implements Comparator
{
    ...
    /**
     * Sort semantic objects.
     *
     * @param lang the lang
     * @param its the its
     * @return the iterator
     */
    public static Iterator sortSemanticObjects(String lang, Iterator... its)
    {
        return sortSemanticObjects(new SWBComparator(lang), its);
    }

    public static Iterator sortSemanticObjects(Comparator comp, Iterator... its)
    {
    ...
    /*
     public static Iterator sortSemanticObjects(Iterator it, String lang)
     {
