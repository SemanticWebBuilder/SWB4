...
public class ApplicationBase extends SemanticObject implements Priorityable,RoleRefable,Groupable,Deleteable,WebSiteable,Referensable,Localeable,RuleRefable,Calendarable,Descriptiveable,Statusable
{
    SWBVocabulary vocabulary=SWBContext.getVocabulary();

    public ApplicationBase(com.hp.hpl.jena.rdf.model.Resource res)
    {
        super(res);
    }
