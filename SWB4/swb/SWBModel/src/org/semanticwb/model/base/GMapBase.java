...
public abstract class GMapBase extends org.semanticwb.model.base.FormElementBase 
{
    ...
    public static class ClassMgr
    {
         ...
         * @param id the id
         * @param model the model
         * @return the org.semanticwb.model. g map
         */
    ...
    /**
     * Gets the inits the latitude.
     * 
     * @return the inits the latitude
     */
    ...
    /**
     * Sets the inits the latitude.
     * 
     * @param value the new inits the latitude
     */
    ...
    /**
     * Gets the inits the longitude.
     * 
     * @return the inits the longitude
     */
    ...
    /**
     * Sets the inits the longitude.
     * 
     * @param value the new inits the longitude
     */
    ...
    /**
     * Sets the inits the step.
     * 
     * @param value the new inits the step
     */
