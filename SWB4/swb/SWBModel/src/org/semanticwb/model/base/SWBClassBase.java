...
public class SWBClassBase extends org.semanticwb.model.base.GenericObjectBase 
{
    ...
    {
        return (org.semanticwb.model.SWBClass)model.getSemanticObject().getModel().createGenericObject(model.getSemanticObject().getModel().getObjectUri(id, swb_SWBClass), swb_SWBClass);
    }
