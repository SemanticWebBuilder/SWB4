...
public class ResourceBase extends SemanticObject implements Statusable,Groupable,Calendarable,RoleRefable,WebSiteable,RuleRefable,Localeable,Descriptiveable,Priorityable,Deleteable,Referensable
{
    SWBVocabulary vocabulary=SWBContext.getVocabulary();

    public ResourceBase(com.hp.hpl.jena.rdf.model.Resource res)
    {
        super(res);
    }
