...
public class TemplateGroupBase extends org.semanticwb.model.SWBClass implements org.semanticwb.model.Traceable,org.semanticwb.model.Descriptiveable,org.semanticwb.model.Filterable
{
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.TemplateGroup> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_modifiedBy, modifiedby.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.TemplateGroup> it=new org.semanticwb.model.GenericIterator(modifiedby.getSemanticObject().getModel().listSubjects(ClassMgr.swb_modifiedBy,modifiedby.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.TemplateGroup> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_creator, creator.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.TemplateGroup> it=new org.semanticwb.model.GenericIterator(creator.getSemanticObject().getModel().listSubjects(ClassMgr.swb_creator,creator.getSemanticObject()));
       return it;
   }
    ...
    {
        return new org.semanticwb.model.GenericIterator<org.semanticwb.model.Template>(getSemanticObject().listObjectProperties(ClassMgr.swb_hasGroupedTemplate));
    }

    public boolean hasTemplate(org.semanticwb.model.Template template)
    {
        if(template==null)return false;
        return getSemanticObject().hasObjectProperty(ClassMgr.swb_hasGroupedTemplate,template.getSemanticObject());
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.TemplateGroup> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_hasGroupedTemplate, hasgroupedtemplate.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.TemplateGroup> it=new org.semanticwb.model.GenericIterator(hasgroupedtemplate.getSemanticObject().getModel().listSubjects(ClassMgr.swb_hasGroupedTemplate,hasgroupedtemplate.getSemanticObject()));
       return it;
   }
    ...
    public org.semanticwb.model.Template getTemplate()
    {
         ...
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(ClassMgr.swb_hasGroupedTemplate);
         if(obj!=null)
         {
