...
public class AssMemberBase extends org.semanticwb.model.SWBClass 
{
    ...
    {
        getSemanticObject().setObjectProperty(ClassMgr.swb_assMember, value.getSemanticObject());
    }

    public void removeMember()
    {
        getSemanticObject().removeProperty(ClassMgr.swb_assMember);
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.AssMember> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_assMember, assmember.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.AssMember> it=new org.semanticwb.model.GenericIterator(assmember.getSemanticObject().getModel().listSubjects(ClassMgr.swb_assMember,assmember.getSemanticObject()));
       return it;
   }
    ...
    public org.semanticwb.model.Topic getMember()
    {
         ...
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(ClassMgr.swb_assMember);
         if(obj!=null)
         {
    ...
    {
        getSemanticObject().setObjectProperty(ClassMgr.swb_assRole, value.getSemanticObject());
    }

    public void removeRole()
    {
        getSemanticObject().removeProperty(ClassMgr.swb_assRole);
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.AssMember> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_assRole, assrole.getSemanticObject()));
       return it;
   }

   public static java.util.Iterator<org.semanticwb.model.AssMember> listAssMemberByRole(org.semanticwb.model.Topic assrole)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.AssMember> it=new org.semanticwb.model.GenericIterator(assrole.getSemanticObject().getModel().listSubjects(ClassMgr.swb_assRole,assrole.getSemanticObject()));
       return it;
   }
    ...
    {
         org.semanticwb.model.Topic ret=null;
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(ClassMgr.swb_assRole);
         if(obj!=null)
         {
             ret=(org.semanticwb.model.Topic)obj.createGenericInstance();
         }
    ...
    {
        getSemanticObject().setObjectProperty(ClassMgr.swb_associationInv, value.getSemanticObject());
    }

    public void removeAssociation()
    {
        getSemanticObject().removeProperty(ClassMgr.swb_associationInv);
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.AssMember> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_associationInv, associationinv.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.AssMember> it=new org.semanticwb.model.GenericIterator(associationinv.getSemanticObject().getModel().listSubjects(ClassMgr.swb_associationInv,associationinv.getSemanticObject()));
       return it;
   }
    ...
    public org.semanticwb.model.Association getAssociation()
    {
         ...
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(ClassMgr.swb_associationInv);
         if(obj!=null)
         {
