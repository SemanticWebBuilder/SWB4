...
public class DnsBase extends GenericObjectBase implements WebPageable,Descriptiveable,Traceable
{
    ...
    {
        getSemanticObject().setObjectProperty(vocabulary.swb_webPage, webpage.getSemanticObject());
    }

    public void removeWebPage()
    {
        getSemanticObject().removeProperty(vocabulary.swb_webPage);
    }

    public WebPage getWebPage()
    {
         WebPage ret=null;
         SemanticObject obj=getSemanticObject().getObjectProperty(vocabulary.swb_webPage);
         if(obj!=null)
         {
    ...
    {
        return getSemanticObject().getBooleanProperty(vocabulary.swb_dnsDefault);
    }
