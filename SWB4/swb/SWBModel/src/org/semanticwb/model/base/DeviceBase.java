...
public class DeviceBase extends org.semanticwb.model.SWBClass implements org.semanticwb.model.Traceable,org.semanticwb.model.Descriptiveable
{
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.Device> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_modifiedBy, modifiedby.getSemanticObject()));
       return it;
   }

   public static java.util.Iterator<org.semanticwb.model.Device> listDeviceByModifiedBy(org.semanticwb.model.User modifiedby)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.Device> it=new org.semanticwb.model.GenericIterator(modifiedby.getSemanticObject().getModel().listSubjects(ClassMgr.swb_modifiedBy,modifiedby.getSemanticObject()));
       return it;
   }
    ...
    {
        getSemanticObject().setObjectProperty(ClassMgr.swb_dvcParent, value.getSemanticObject());
    }

    public void removeParent()
    {
        getSemanticObject().removeProperty(ClassMgr.swb_dvcParent);
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.Device> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_dvcParent, dvcparent.getSemanticObject()));
       return it;
   }

   public static java.util.Iterator<org.semanticwb.model.Device> listDeviceByParent(org.semanticwb.model.Device dvcparent)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.Device> it=new org.semanticwb.model.GenericIterator(dvcparent.getSemanticObject().getModel().listSubjects(ClassMgr.swb_dvcParent,dvcparent.getSemanticObject()));
       return it;
   }
    ...
    public org.semanticwb.model.Device getParent()
    {
         ...
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(ClassMgr.swb_dvcParent);
         if(obj!=null)
         {
    ...
    {
        return new org.semanticwb.model.GenericIterator<org.semanticwb.model.Device>(getSemanticObject().listObjectProperties(ClassMgr.swb_hasDvcChild));
    }

    public boolean hasChild(org.semanticwb.model.Device device)
    {
        if(device==null)return false;
        return getSemanticObject().hasObjectProperty(ClassMgr.swb_hasDvcChild,device.getSemanticObject());
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.Device> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_hasDvcChild, hasdvcchild.getSemanticObject()));
       return it;
   }

   public static java.util.Iterator<org.semanticwb.model.Device> listDeviceByChild(org.semanticwb.model.Device hasdvcchild)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.Device> it=new org.semanticwb.model.GenericIterator(hasdvcchild.getSemanticObject().getModel().listSubjects(ClassMgr.swb_hasDvcChild,hasdvcchild.getSemanticObject()));
       return it;
   }
    ...
    {
         org.semanticwb.model.Device ret=null;
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(ClassMgr.swb_hasDvcChild);
         if(obj!=null)
         {
             ret=(org.semanticwb.model.Device)obj.createGenericInstance();
         }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.Device> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_creator, creator.getSemanticObject()));
       return it;
   }

   public static java.util.Iterator<org.semanticwb.model.Device> listDeviceByCreator(org.semanticwb.model.User creator)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.Device> it=new org.semanticwb.model.GenericIterator(creator.getSemanticObject().getModel().listSubjects(ClassMgr.swb_creator,creator.getSemanticObject()));
       return it;
   }
    ...
    {
        return getSemanticObject().getProperty(ClassMgr.swb_dvcUserAgent);
    }

    public void setUserAgent(String value)
    {
        getSemanticObject().setProperty(ClassMgr.swb_dvcUserAgent, value);
    }
