...
public class TextAreaBase extends org.semanticwb.model.base.FormElementBase 
{
    ...
    public int getRows()
    {
        return getSemanticObject().getIntProperty(ClassMgr.swbxf_textAreaRows);
    }

    public void setRows(int value)
    {
        getSemanticObject().setIntProperty(ClassMgr.swbxf_textAreaRows, value);
    }

    public int getCols()
    {
        return getSemanticObject().getIntProperty(ClassMgr.swbxf_textAreaCols);
    }

    public void setCols(int value)
    {
        getSemanticObject().setIntProperty(ClassMgr.swbxf_textAreaCols, value);
    }
