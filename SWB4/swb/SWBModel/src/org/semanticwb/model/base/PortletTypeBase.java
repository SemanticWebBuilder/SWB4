...
public class PortletTypeBase extends org.semanticwb.model.SWBClass implements org.semanticwb.model.Filterable,org.semanticwb.model.Traceable,org.semanticwb.model.Descriptiveable
{
    ...
    {
        return getSemanticObject().getProperty(swb_portletBundle);
    }
    ...
    {
        return getSemanticObject().getIntProperty(swb_portletMode);
    }

    public void setPortletMode(int portletMode)
    {
        getSemanticObject().setLongProperty(swb_portletMode, portletMode);
    }
    ...
    public org.semanticwb.model.Portlet getPortlet()
    {
         ...
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(swb_hasPTPortlet);
         if(obj!=null)
         {
