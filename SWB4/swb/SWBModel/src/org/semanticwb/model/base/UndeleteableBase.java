...
public interface UndeleteableBase extends org.semanticwb.model.GenericObject
{
    ...
    /**
     * Checks if is undeleteable.
     * 
     * @return true, if is undeleteable
     */
    public boolean isUndeleteable();

    /**
     * Sets the undeleteable.
     * 
     * @param value the new undeleteable
     */
