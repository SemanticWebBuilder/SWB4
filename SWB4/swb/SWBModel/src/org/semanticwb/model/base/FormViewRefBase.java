...
public class FormViewRefBase extends org.semanticwb.model.Reference implements org.semanticwb.model.Activeable
{
    ...
    {
        getSemanticObject().setObjectProperty(ClassMgr.swb_formView, value.getSemanticObject());
    }

    public void removeFormView()
    {
        getSemanticObject().removeProperty(ClassMgr.swb_formView);
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.FormViewRef> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swb_formView, formview.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.model.FormViewRef> it=new org.semanticwb.model.GenericIterator(formview.getSemanticObject().getModel().listSubjects(ClassMgr.swb_formView,formview.getSemanticObject()));
       return it;
   }
    ...
    public org.semanticwb.model.FormView getFormView()
    {
         ...
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(ClassMgr.swb_formView);
         if(obj!=null)
         {
    ...
    {
        return getSemanticObject().getProperty(ClassMgr.swb_formMode);
    }

    public void setFormMode(String value)
    {
        getSemanticObject().setProperty(ClassMgr.swb_formMode, value);
    }
}
