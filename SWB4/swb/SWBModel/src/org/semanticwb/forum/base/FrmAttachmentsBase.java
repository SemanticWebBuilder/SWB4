...
public class FrmAttachmentsBase extends org.semanticwb.model.SWBClass implements org.semanticwb.model.Traceable
{
    ...
    public static final org.semanticwb.platform.SemanticClass sclass=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticClass("http://www.semanticwebbuilder.org/swb4/forum#FrmAttachment");
    ...
    {
        getSemanticObject().setObjectProperty(frm_atPost, frmpost.getSemanticObject());
    }
