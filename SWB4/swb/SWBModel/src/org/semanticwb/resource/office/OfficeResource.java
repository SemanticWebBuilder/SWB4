...
public class OfficeResource extends org.semanticwb.resource.office.base.OfficeResourceBase
{
    private static Logger log = SWBUtils.getLogger(OfficeResource.class);

    public OfficeResource(org.semanticwb.platform.SemanticObject base)
    {
        super(base);
    }
