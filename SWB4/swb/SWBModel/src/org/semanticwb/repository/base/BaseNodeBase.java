...
public class BaseNodeBase extends org.semanticwb.model.base.GenericObjectBase 
{
    ...
    {
        getSemanticObject().setObjectProperty(ClassMgr.swbrep_parentNode, value.getSemanticObject());
    }

    public void removeParent()
    {
        getSemanticObject().removeProperty(ClassMgr.swbrep_parentNode);
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.repository.BaseNode> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swbrep_parentNode, parentnode.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.repository.BaseNode> it=new org.semanticwb.model.GenericIterator(parentnode.getSemanticObject().getModel().listSubjects(ClassMgr.swbrep_parentNode,parentnode.getSemanticObject()));
       return it;
   }
    ...
    {
        return getSemanticObject().getProperty(ClassMgr.jcr_primaryType);
    }

    public void setPrimaryType(String value)
    {
        getSemanticObject().setProperty(ClassMgr.jcr_primaryType, value);
    }

    public String getPath()
    {
        return getSemanticObject().getProperty(ClassMgr.swbrep_path);
    }

    public void setPath(String value)
    {
        getSemanticObject().setProperty(ClassMgr.swbrep_path, value);
    }

    public String getName()
    {
        return getSemanticObject().getProperty(ClassMgr.swbrep_name);
    }

    public void setName(String value)
    {
        getSemanticObject().setProperty(ClassMgr.swbrep_name, value);
    }

    public org.semanticwb.model.GenericIterator<org.semanticwb.repository.BaseNode> listNodes()
    {
        return new org.semanticwb.model.GenericIterator<org.semanticwb.repository.BaseNode>(getSemanticObject().listObjectProperties(ClassMgr.swbrep_hasNodes));
    }

    public boolean hasNode(org.semanticwb.repository.BaseNode basenode)
    {
        if(basenode==null)return false;
        return getSemanticObject().hasObjectProperty(ClassMgr.swbrep_hasNodes,basenode.getSemanticObject());
    }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.repository.BaseNode> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(ClassMgr.swbrep_hasNodes, hasnodes.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.repository.BaseNode> it=new org.semanticwb.model.GenericIterator(hasnodes.getSemanticObject().getModel().listSubjects(ClassMgr.swbrep_hasNodes,hasnodes.getSemanticObject()));
       return it;
   }
    ...
    {
         org.semanticwb.repository.BaseNode ret=null;
         org.semanticwb.platform.SemanticObject obj=getSemanticObject().getObjectProperty(ClassMgr.swbrep_hasNodes);
         if(obj!=null)
         {
             ret=(org.semanticwb.repository.BaseNode)obj.createGenericInstance();
         }
    ...
    {
        return getSemanticObject().getProperty(ClassMgr.jcr_mixinTypes);
    }

    public void setMixinTypes(String value)
    {
        getSemanticObject().setProperty(ClassMgr.jcr_mixinTypes, value);
    }
