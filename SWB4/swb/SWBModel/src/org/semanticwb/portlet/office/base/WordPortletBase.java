...
public class WordPortletBase extends org.semanticwb.portlet.office.OfficePortlet 
{
    ...
    {
        return (org.semanticwb.portlet.office.WordPortlet)model.getSemanticObject().getModel().createGenericObject(model.getSemanticObject().getModel().getObjectUri(id, swbrep_WordPortlet), swbrep_WordPortlet);
    }
