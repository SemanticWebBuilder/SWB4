...
public interface FacilitiesEnable extends org.semanticwb.model.GenericObject
{
    ...
    public void setFoodCourt(boolean foodCourt);
    public boolean isElevator();
    public void setElevator(boolean elevator);
    public boolean isParkingLot();
    public void setParkingLot(boolean parkingLot);
    public boolean isImpairedPeopleAccessible();
    public void setImpairedPeopleAccessible(boolean impairedPeopleAccessible);
}
