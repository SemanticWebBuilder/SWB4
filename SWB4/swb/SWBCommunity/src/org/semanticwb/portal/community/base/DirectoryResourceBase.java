...
public class DirectoryResourceBase extends org.semanticwb.portal.community.CommunityResource 
{
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.portal.community.DirectoryResource> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(swbcomm_hasDirectoryObjectInv, hasdirectoryobjectinv.getSemanticObject()));
       return it;
   }
   ...
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.portal.community.DirectoryResource> it=new org.semanticwb.model.GenericIterator(hasdirectoryobjectinv.getSemanticObject().getModel().listSubjects(swbcomm_hasDirectoryObjectInv,hasdirectoryobjectinv.getSemanticObject()));
       return it;
   }
