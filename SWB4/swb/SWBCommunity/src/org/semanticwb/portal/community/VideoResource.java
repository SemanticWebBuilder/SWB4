...
public class VideoResource extends org.semanticwb.portal.community.base.VideoResourceBase
{
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException
    {
        ...
        if(act.equals("add"))path="/swbadmin/jsp/microsite/VideoResource/videoAdd.jsp";
        if(act.equals("edit"))path="/swbadmin/jsp/microsite/VideoResource/videoEdit.jsp";
        if(act.equals("detail"))path="/swbadmin/jsp/microsite/VideoResource/videoDetail.jsp";
