 ...
 */
public class SWBSFlickerImp extends SWBSocialNetWork
{
    private static Logger log = SWBUtils.getLogger(SWBSFlickerImp.class);

    SWBModel model=null;

    public SWBSFlickerImp(SWBModel model)
    {
        super(model);
        this.model=model;
    ...
    {
        connect();
        System.out.println("Enviando Mensaje a publicar en SWBSFlickerImp:"+msg);
        disConnect();
    }
