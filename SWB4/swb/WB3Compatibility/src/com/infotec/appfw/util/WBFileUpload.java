...
public class WBFileUpload
{
        ...
        throws IOException
    {
        ...
        catch(Throwable throwable)
        {
            ...
            AFUtils.getInstance().log(throwable, "Error en WBFileUpload al generar variables de request..",true);
            return;
        }
    }
            ...
            if(s2.equals(s))
            {
                ...
                if(obj instanceof Hashtable)
                {
                    ...
                    if(s3 != null)
                    {
                        ...
                        String dataarc = "";
                        if(s3.endsWith(".xsl") || s3.endsWith(".xslt")) dataarc=WBUtils.getInstance().parseXsl(strNoparsed, s0);
                        else dataarc = WBUtils.getInstance().parseHTML(strNoparsed, s0);
        ...
        do
        {
            ...
            if(s2.equals(s))
            {
                ...
                if(obj instanceof Hashtable)
                {
                    ...
                    byte abyte0[] = (byte[])obj;
                    String strNoparsed = new String(abyte0);
                    dataarc = WBUtils.getInstance().FindAttaches(strNoparsed);
                }
            }
        } while(true);
        return dataarc;
    ...
    Hashtable parseMulti(String s, ServletInputStream servletinputstream) 
    {
     ...
     }catch(Exception e){AFUtils.getInstance().log(e);}
     return null;
    }
