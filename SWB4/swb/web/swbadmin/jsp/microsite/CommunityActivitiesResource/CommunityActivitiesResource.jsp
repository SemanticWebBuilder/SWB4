...
<div id="actividades">
    ...
    %>
        <li>
            <a class="contactos_nombre" href="<%=mse.getURL()%>"><img src="/work/models/Ciudad_Digital/css/boton_contacto.png" alt=""></a>
            <%=user.getFullName()%> agregó <a class="contactos_nombre" href="<%=mse.getURL()%>"><%=mse.getDisplayTitle(user.getLanguage())%></a>
            <%=SWBUtils.TEXT.getTimeAgo(mse.getUpdated(), visitor.getLanguage())%>.
        </li>
    <%
            }
        }
