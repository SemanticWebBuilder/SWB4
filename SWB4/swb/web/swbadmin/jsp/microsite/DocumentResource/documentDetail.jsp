...
<div class="columnaIzquierda">
    <p><a href="<%= SWBPortal.getWebWorkPath()+doc.getDocumentURL()%>" target="new"><%= doc.getTitle()%></a></p>
</div>
<%
    }
...
<div class="columnaCentro">
    <h2 class="blogTitle"><a href="<%= SWBPortal.getWebWorkPath()+doc.getDocumentURL()%>" target="new"><%= doc.getTitle()%></a></h2><br>
