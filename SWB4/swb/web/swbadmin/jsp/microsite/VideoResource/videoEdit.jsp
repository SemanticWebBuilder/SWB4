                ...
                <div>
                    <fieldset>
                        <legend><strong>¿Quién puede ver este video?</strong></legend>
                            ...
                            <label><input type="radio" class="radio" name="level" value="0" <%if(rec.getVisibility()==0)out.println(chk);%>/> Cualquiera</label><br>
                            <label><input type="radio" class="radio" name="level" value="1" <%if(rec.getVisibility()==1)out.println(chk);%>/> Sólo los miembros</label><br>
                            <label><input type="radio" class="radio" name="level" value="3" <%if(rec.getVisibility()==3)out.println(chk);%>/> Sólo yo</label>
