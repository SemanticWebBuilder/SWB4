...
<form id="userFilter/form" dojoType="dijit.form.Form" class="swbform" action="<%=path%>"  onsubmit="submitForm('userFilter/form'); return false;" method="post">
    ...
    <fieldset>
        <table>
            <tr>
                ...
                <td>
                    <select id="uf_userRep" name="userRep" dojoType="dijit.form.FilteringSelect" onchange="submitForm('userFilter/form')" autoComplete="true" invalidMessage="Dato invalido." value="<%=userRep%>" >
                        <%
