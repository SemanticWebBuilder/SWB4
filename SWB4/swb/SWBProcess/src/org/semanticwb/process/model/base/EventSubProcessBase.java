...
public abstract class EventSubProcessBase extends org.semanticwb.process.model.SubProcess implements org.semanticwb.model.Descriptiveable,org.semanticwb.model.Traceable,org.semanticwb.process.model.ActivityConfable,org.semanticwb.model.TemplateRefable,org.semanticwb.process.model.ResourceAssignmentable,org.semanticwb.model.Referensable,org.semanticwb.process.model.Containerable
{
   ...
   */
    ...
    public static class ClassMgr
    {
       ...
       */
       ...
       /**
       * Gets all org.semanticwb.process.model.EventSubProcess with a determined ResourceAssignment
       * @param value ResourceAssignment of the type org.semanticwb.process.model.ResourceAssignment
       * @param model Model of the org.semanticwb.process.model.EventSubProcess
       * @return Iterator with all the org.semanticwb.process.model.EventSubProcess
       */

        public static java.util.Iterator<org.semanticwb.process.model.EventSubProcess> listEventSubProcessByResourceAssignment(org.semanticwb.process.model.ResourceAssignment value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.model.EventSubProcess> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swp_resourceAssignment, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.process.model.EventSubProcess with a determined ResourceAssignment
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.process.model.EventSubProcess> listEventSubProcessByResourceAssignment(org.semanticwb.process.model.ResourceAssignment value)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.model.EventSubProcess> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swp_resourceAssignment,value.getSemanticObject(),sclass));
            return it;
        }
       /**
