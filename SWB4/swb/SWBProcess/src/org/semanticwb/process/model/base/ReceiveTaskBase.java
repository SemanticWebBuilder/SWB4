...
public abstract class ReceiveTaskBase extends org.semanticwb.process.model.Task implements org.semanticwb.process.model.Observable,org.semanticwb.process.model.Performable,org.semanticwb.process.model.Implementable,org.semanticwb.process.model.Modelable,org.semanticwb.model.Descriptiveable,org.semanticwb.process.model.IOAble,org.semanticwb.process.model.Messageable,org.semanticwb.process.model.Assignable,org.semanticwb.process.model.Instantiable
{
   ...
   public static java.util.Iterator<org.semanticwb.process.model.ReceiveTask> listReceiveTaskByInMessageRef(org.semanticwb.process.model.Message inmessageref,org.semanticwb.model.SWBModel model)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.process.model.ReceiveTask> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(swp_inMessageRef, inmessageref.getSemanticObject()));
       return it;
   }

   public static java.util.Iterator<org.semanticwb.process.model.ReceiveTask> listReceiveTaskByInMessageRef(org.semanticwb.process.model.Message inmessageref)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.process.model.ReceiveTask> it=new org.semanticwb.model.GenericIterator(inmessageref.getSemanticObject().getModel().listSubjects(swp_inMessageRef,inmessageref.getSemanticObject()));
       return it;
   }
   ...
   public static java.util.Iterator<org.semanticwb.process.model.ReceiveTask> listReceiveTaskByOutMessageRef(org.semanticwb.process.model.Message outmessageref,org.semanticwb.model.SWBModel model)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.process.model.ReceiveTask> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(swp_outMessageRef, outmessageref.getSemanticObject()));
       return it;
   }

   public static java.util.Iterator<org.semanticwb.process.model.ReceiveTask> listReceiveTaskByOutMessageRef(org.semanticwb.process.model.Message outmessageref)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.process.model.ReceiveTask> it=new org.semanticwb.model.GenericIterator(outmessageref.getSemanticObject().getModel().listSubjects(swp_outMessageRef,outmessageref.getSemanticObject()));
       return it;
   }
