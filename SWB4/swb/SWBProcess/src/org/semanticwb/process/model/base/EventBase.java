...
public abstract class EventBase extends org.semanticwb.process.model.FlowObject implements org.semanticwb.model.Descriptiveable,org.semanticwb.process.model.Assignable
{
       public static final org.semanticwb.platform.SemanticProperty swp_eventType=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticProperty("http://www.semanticwebbuilder.org/swb4/swp#eventType");
   ...
   public static java.util.Iterator<org.semanticwb.process.model.Event> listEventByAssignment(org.semanticwb.process.model.Assignment hasassignment)
   {
    ...
    {
        return getSemanticObject().getProperty(swp_eventType);
    }

    public void setEventType(String value)
    {
        getSemanticObject().setProperty(swp_eventType, value);
    }
}
