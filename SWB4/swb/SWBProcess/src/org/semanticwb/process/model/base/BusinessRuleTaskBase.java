...
public abstract class BusinessRuleTaskBase extends org.semanticwb.process.model.Task implements org.semanticwb.model.Traceable,org.semanticwb.process.model.ActivityConfable,org.semanticwb.process.model.Callable,org.semanticwb.model.Descriptiveable,org.semanticwb.process.model.ResourceAssignmentable
{
   ...
   */
    ...
    public static class ClassMgr
    {
       ...
       */
       ...
       /**
       * Gets all org.semanticwb.process.model.BusinessRuleTask with a determined ResourceAssignment
       * @param value ResourceAssignment of the type org.semanticwb.process.model.ResourceAssignment
       * @param model Model of the org.semanticwb.process.model.BusinessRuleTask
       * @return Iterator with all the org.semanticwb.process.model.BusinessRuleTask
       */

        public static java.util.Iterator<org.semanticwb.process.model.BusinessRuleTask> listBusinessRuleTaskByResourceAssignment(org.semanticwb.process.model.ResourceAssignment value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.model.BusinessRuleTask> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swp_resourceAssignment, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.process.model.BusinessRuleTask with a determined ResourceAssignment
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.process.model.BusinessRuleTask> listBusinessRuleTaskByResourceAssignment(org.semanticwb.process.model.ResourceAssignment value)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.model.BusinessRuleTask> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swp_resourceAssignment,value.getSemanticObject(),sclass));
            return it;
        }
       /**
