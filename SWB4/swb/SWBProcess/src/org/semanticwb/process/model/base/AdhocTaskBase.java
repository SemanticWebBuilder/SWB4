...
public abstract class AdhocTaskBase extends org.semanticwb.process.model.Task implements org.semanticwb.model.Descriptiveable,org.semanticwb.model.Traceable
{
    ...
    public static class ClassMgr
    {
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.model.AdhocTask> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swp_hasFlowNodeInstansInv, value.getSemanticObject(),sclass));
            return it;
        }
        ...
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.model.AdhocTask> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swp_hasFlowNodeInstansInv,value.getSemanticObject(),sclass));
            return it;
        }
        ...
        public static java.util.Iterator<org.semanticwb.process.model.AdhocTask> listAdhocTaskByOutputConnectionObjectInv(org.semanticwb.process.model.ConnectionObject value,org.semanticwb.model.SWBModel model)
        {
        ...
        public static java.util.Iterator<org.semanticwb.process.model.AdhocTask> listAdhocTaskByOutputConnectionObjectInv(org.semanticwb.process.model.ConnectionObject value)
        {
