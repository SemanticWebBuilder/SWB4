...
public abstract class EmbeddedSubProcessBase extends org.semanticwb.process.model.SubProcess implements org.semanticwb.process.model.Observable,org.semanticwb.process.model.Performable,org.semanticwb.process.model.Diagramable,org.semanticwb.process.model.AdHocable,org.semanticwb.process.model.Modelable,org.semanticwb.model.Descriptiveable,org.semanticwb.process.model.IOAble,org.semanticwb.process.model.Assignable
{
   ...
   public static java.util.Iterator<org.semanticwb.process.model.EmbeddedSubProcess> listEmbeddedSubProcessByAdHocCompletionCondition(org.semanticwb.process.model.Expression adhoccompletioncondition,org.semanticwb.model.SWBModel model)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.process.model.EmbeddedSubProcess> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjects(swp_adHocCompletionCondition, adhoccompletioncondition.getSemanticObject()));
       return it;
   }

   public static java.util.Iterator<org.semanticwb.process.model.EmbeddedSubProcess> listEmbeddedSubProcessByAdHocCompletionCondition(org.semanticwb.process.model.Expression adhoccompletioncondition)
   {
       org.semanticwb.model.GenericIterator<org.semanticwb.process.model.EmbeddedSubProcess> it=new org.semanticwb.model.GenericIterator(adhoccompletioncondition.getSemanticObject().getModel().listSubjects(swp_adHocCompletionCondition,adhoccompletioncondition.getSemanticObject()));
       return it;
   }
