...
public abstract class EndEventBase extends org.semanticwb.process.Event implements org.semanticwb.model.Descriptiveable,org.semanticwb.process.FlowObject,org.semanticwb.model.Traceable
{
    ...
    public static class ClassMgr
    {
       ...
       public static java.util.Iterator<org.semanticwb.process.EndEvent> listEndEvents(org.semanticwb.model.SWBModel model)
       {
           java.util.Iterator it=model.getSemanticObject().getModel().listInstancesOfClass(sclass);
           return new org.semanticwb.model.GenericIterator<org.semanticwb.process.EndEvent>(it, true);
       }

       public static java.util.Iterator<org.semanticwb.process.EndEvent> listEndEvents()
       {
           java.util.Iterator it=sclass.listInstances();
           return new org.semanticwb.model.GenericIterator<org.semanticwb.process.EndEvent>(it, true);
       }

       public static org.semanticwb.process.EndEvent createEndEvent(org.semanticwb.model.SWBModel model)
       {
           long id=model.getSemanticObject().getModel().getCounter(sclass);
           return org.semanticwb.process.EndEvent.ClassMgr.createEndEvent(String.valueOf(id), model);
       }

       public static org.semanticwb.process.EndEvent getEndEvent(String id, org.semanticwb.model.SWBModel model)
       {
           return (org.semanticwb.process.EndEvent)model.getSemanticObject().getModel().getGenericObject(model.getSemanticObject().getModel().getObjectUri(id,sclass),sclass);
       }

       public static org.semanticwb.process.EndEvent createEndEvent(String id, org.semanticwb.model.SWBModel model)
       {
           return (org.semanticwb.process.EndEvent)model.getSemanticObject().getModel().createGenericObject(model.getSemanticObject().getModel().getObjectUri(id, sclass), sclass);
       }
