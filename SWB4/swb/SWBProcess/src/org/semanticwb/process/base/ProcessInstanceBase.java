...
public abstract class ProcessInstanceBase extends org.semanticwb.process.FlowObjectInstance implements org.semanticwb.model.Traceable,org.semanticwb.process.ProcessTraceable
{
    ...
    public boolean hasProcessObject(org.semanticwb.process.ProcessObject processobject)
    {
        ...
        {
           ret=getSemanticObject().hasObjectProperty(swbps_hasProcessObject,processobject.getSemanticObject());
        }
        return ret;
    }
    ...
    public boolean hasFlowObjectInstance(org.semanticwb.process.FlowObjectInstance flowobjectinstance)
    {
        ...
        {
           ret=getSemanticObject().hasObjectProperty(swbps_hasFlowObjectInstance,flowobjectinstance.getSemanticObject());
        }
        return ret;
    }
