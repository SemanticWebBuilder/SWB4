...
public class ProcessForm extends GenericResource {
    ...
    public static final String ADM_MODEADVANCED = "advanced";
...
//                        if (canUserView) {
        ...
        //                        out.println("<legend>Datos Generales</legend>");
                            ...
                            if (ele == null) {
                                ...
                                out.println("<tr><td width=\"200px\" align=\"right\"><label for=\"title\">" + ele.renderLabel(request, null, semprop, propsMap.get("varName") + "." + semprop.getName(), SWBFormMgr.TYPE_DOJO, SWBFormMgr.MODE_CREATE, lang) + "</label></td>");
                            }
                            out.println("<td>");
                            if (null != sofe) {
