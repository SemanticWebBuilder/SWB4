 ...
 */
package org.semanticwb.portal.resources.zkoss;
...
/** Este recurso permite ejecutar un archivo zul, dando la ruta del archivo a
 * ejecutar dentro del sitio, pudi&eacute;ndose presentar como contenido o como
 * recurso.
 *
 * This resource allows to execute a ZUL file, giving the file path to execute
 * within the site, showing it as a content or as a resource.
 *
 * @author Javier Solis Gonz&aacute;lez
 */
public class ZULResource extends GenericAdmResource 
{
     ...
     */
    private static Logger log = SWBUtils.getLogger(ZULResource.class);
