...
<div class="cuerpo">
    ...
    <div class="dataset-detalle">
        <img class="logo" src="<%=instlogo%>" alt="<%=instname%>" />
        <p class="desc"><%=ds.getDatasetDescription()%></p>
        <%
            if (!urlLic.equals("#") && ds.getLicense() != null) {
                urlLic += "?suri=" + ds.getLicense().getShortURI();
            }
        %>
        <p class="lic"><strong><%=paramRequest.getLocaleString("lbl_licenseUse")%>:</strong> <a href="<%=urlLic%>" ><%=ds.getLicense() != null ? ds.getLicense().getLicenseTitle() : paramRequest.getLocaleString("lbl_notassigned")%></a></em></p>
        <p class="etiq"><strong><%=paramRequest.getLocaleString("lbl_labels")%>:</strong>
            <%
            ...
            %>
            <a href="<%=thiswpurl + tag.getTagName().trim()%>"><%=tag.getTagName().trim()%></a>
            <%
                    }
                }
            %>
        ...
        <div class="acerca-data">
            <fieldset>
                <legend>Más de este dataset</legend>                
                <%
        ...
        <div class="acerca-pub">
            <fieldset>
                <legend>Acerca del publicador</legend>
                <ul>
                    <li><strong><%=instname%></strong></li>
                    <li><%=paramRequest.getLocaleString("lbl_gowebsite")%>: <a href="<%=instweburl%>" title="<%=instweburl%>"><%=instweburl%></a></li> 
                    <li><%=paramRequest.getLocaleString("lbl_technicalContact")%>:<a href="<%=pub != null && pub.getEmail() != null ? "mailto:"+pub.getEmail() : "#"%>" title="<%=pub != null && pub.getEmail() != null ? pub.getEmail() : "---"%>"><%=pub != null && pub.getFullName() != null ? pub.getFullName() : "---"%></a></li>
                </ul>
            </fieldset>
        </div>
