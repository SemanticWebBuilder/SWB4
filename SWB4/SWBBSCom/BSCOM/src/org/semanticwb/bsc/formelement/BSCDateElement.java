...
public class BSCDateElement extends org.semanticwb.bsc.formelement.base.BSCDateElementBase 
{
    public BSCDateElement(org.semanticwb.platform.SemanticObject base)
    {
        super(base);
    }
    @Override
