...
public abstract class BSCBase extends org.semanticwb.model.WebSite implements org.semanticwb.model.Descriptiveable,org.semanticwb.model.Indexable,org.semanticwb.model.Undeleteable,org.semanticwb.model.Traceable,org.semanticwb.model.Activeable,org.semanticwb.model.Filterable,org.semanticwb.model.Trashable,org.semanticwb.model.Countryable,org.semanticwb.model.FilterableNode,org.semanticwb.model.OntologyDepable,org.semanticwb.model.Localeable,org.semanticwb.model.FilterableClass
{
   ...
   */
    ...
    public org.semanticwb.bsc.element.Action getAction(String id)
    {
        return org.semanticwb.bsc.element.Action.ClassMgr.getAction(id, this);
    }

    public java.util.Iterator<org.semanticwb.bsc.element.Action> listActions()
    {
        return org.semanticwb.bsc.element.Action.ClassMgr.listActions(this);
    }

    public org.semanticwb.bsc.element.Action createAction(String id)
    {
        return org.semanticwb.bsc.element.Action.ClassMgr.createAction(id,this);
    }

    public org.semanticwb.bsc.element.Action createAction()
    {
        long id=getSemanticObject().getModel().getCounter(bsc_Action);
        return org.semanticwb.bsc.element.Action.ClassMgr.createAction(String.valueOf(id),this);
    } 

    public void removeAction(String id)
    {
        org.semanticwb.bsc.element.Action.ClassMgr.removeAction(id, this);
    }
    public boolean hasAction(String id)
    {
        return org.semanticwb.bsc.element.Action.ClassMgr.hasAction(id, this);
    }
